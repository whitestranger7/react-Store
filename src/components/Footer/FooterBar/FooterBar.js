    ...
    return(
        <div className="footerBar">
            <ul>
                ...
                <li><a className="codewars" rel="noopener noreferrer" target="_blank" href="https://www.codewars.com/users/whitestranger7"><span className="iconify" data-icon="simple-icons:codewars" data-inline="false"></span></a></li>
